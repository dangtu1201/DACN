import {generateToken, updateRefreshToken, decodeToken} from "./tokenController.js";
import { User } from "../model/userModel.js";
import { Login } from "../model/loginModel.js";
import { loginValidator } from '../controller/validation/validate.js';
...
export async function refreshToken (req, res) {
	...
	const usernaphoneme = decoded.payload.phone; // Lấy phone từ payload
