...
import productRoute from './controller/routes/productRoute.js';
    ...
    try {   
        ...
        const apolloserver = app.listen(PORT, '0.0.0.0',() => {
            ...
            consola.success({
                ...
                // message: `Successfully started server on http://${ apolloserver.address().address }:${ apolloserver.address().port }/graphql`,
                message: `Successfully started server on http://localhost:${ apolloserver.address().port }/graphql`,
                badge: true,
            })
        });
